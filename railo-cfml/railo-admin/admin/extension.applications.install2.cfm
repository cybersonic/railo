				...
				<tfoot>
				    <tr>
						<td colspan="2">
							...
							<cfif stepLen EQ 1>
								<input type="submit" class="button submit btn btn-primary" name="install" value="#stText.Buttons[iif(not StructKeyExists(detail,"installed"),de('install'),de('update'))]#">
							<cfelseif isFirst>
								<input type="submit" class="button submit btn btn-primary" name="next" value="#stText.Buttons.next#">
							<cfelseif isLast>
								<input type="submit" class="button submit btn btn-primary" name="previous" value="#stText.Buttons.previous#">
								<input type="submit" class="button submit btn btn-primary" name="install" value="#stText.Buttons[iif(not StructKeyExists(detail,"installed"),de('install'),de('update'))]#">
							<cfelse>
								<input type="submit" class="button submit btn btn-primary" name="previous" value="#stText.Buttons.previous#">
								<input type="submit" class="button submit btn btn-primary" name="next" value="#stText.Buttons.next#">
